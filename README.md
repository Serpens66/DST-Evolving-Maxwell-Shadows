...
I replaced the "Decay" of the shadows buy hunger. So the shadows will starve when need feeded nightmarefuel.
...
But the current level system relies on putting fuel into the containers, that is way I did not upload this decay/hunger code yet.
